...
***************************************************************************** */
  ...
  function(e, t, n) {
      ...
      h = (function() {
        function e(e, t, n) {
          ...
          this.INTERNAL = {
            ...
            addAuthTokenListener: function(e) {
              r.tokenListeners_.push(e),
                setTimeout(function() {
                  return e(null);
                }, 0);
            },
            removeAuthTokenListener: function(e) {
              r.tokenListeners_ = r.tokenListeners_.filter(function(t) {
                return t !== e;
              });
            },
            analytics: {
        ...
        return (
          ...
          (e.prototype.delete = function() {
            ...
            return new Promise(function(t) {
              ...
              .then(function() {
                ...
                for (
                  var t = [], n = 0, r = Object.keys(e.services_);
                  n < r.length;
                  n++
                )
                  for (
                    var i = r[n], o = 0, s = Object.keys(e.services_[i]);
                    o < s.length;
                    o++
                  ) {
                    var a = s[o];
          ...
          (e.prototype.extendApp = function(e) {
            if ((o.deepExtend(this, e), e.INTERNAL)) {
              if (e.INTERNAL.addAuthTokenListener) {
                for (var t = 0, n = this.tokenListeners_; t < n.length; t++) {
                  var r = n[t];
                  this.INTERNAL.addAuthTokenListener(r);
                }
                this.tokenListeners_ = [];
              }
              if (e.INTERNAL.analytics) {
                for (
                  var i = 0, s = this.analyticsEventRequests_;
                  i < s.length;
                  i++
                ) {
                  var a = s[i];
                  this.INTERNAL.analytics.logEvent.apply(void 0, a);
                }
                this.analyticsEventRequests_ = [];
              }
            }
    ...
    (h.prototype.name && h.prototype.options) ||
      h.prototype.delete ||
      console.log('dc');
    var c = '7.0.0',
      p = new s.Logger('@firebase/app');
    /**
     * @license
        ...
        (function e() {
          var t =
            ...
            (function(e) {
                ...
                i = {
                  ...
                  initializeApp: function(n, r) {
                    ...
                    if ('string' != typeof a || !a)
                      throw u.create('bad-app-name', { appName: String(a) });
                    if (o.contains(t, a))
                      throw u.create('duplicate-app', { appName: a });
                    var c = new e(n, s, i);
                    return (t[a] = c), h(c, 'create'), c;
                  },
                  app: s,
                  apps: null,
                  SDK_VERSION: c,
                  INTERNAL: {
                    registerService: function(t, l, h, c, d) {
                      void 0 === d && (d = !1);
                      if (n[t])
                        return (
                          p.debug(
                            'There were multiple attempts to register service ' +
                              t +
                              '.'
                          ),
                          i[t]
                      ...
                      function f(e) {
                        if (
                          (void 0 === e && (e = s()), 'function' != typeof e[t])
                        )
              ...
              function s(e) {
                if (((e = e || l), !o.contains(t, e)))
                  throw u.create('no-app', { appName: e });
                return t[e];
              }
              function a() {
          ...
          return (
            (t.INTERNAL = i.__assign({}, t.INTERNAL, {
  ...
  function(e, t, n) {
    ...
    (function(e) {
          ...
          encodeByteArray: function(e, t) {
            ...
            for (
              ...
              var o = e[i],
                ...
                p = ((15 & a) << 2) | (l >> 6),
                d = 63 & l;
              u || ((d = 64), s || (p = 64)), r.push(n[h], n[c], n[p], n[d]);
            }
            return r.join('');
          },
       ...
       */ function h(e, t) {
        ...
        for (var n in t) t.hasOwnProperty(n) && (e[n] = h(e[n], t[n]));
        return e;
      }
      /**
       * @license
          ...
          function t(n, r) {
            ...
            return (
              ...
              Error.captureStackTrace &&
                Error.captureStackTrace(i, y.prototype.create),
              i
            );
          }
        ...
        return (
          ...
          (e.prototype.compress_ = function(e, t) {
            ...
            for (r = 0; r < 80; r++) {
              r < 40
                ? r < 20
                  ? ((o = h ^ (u & (l ^ h))), (s = 1518500249))
                  : ((o = u ^ l ^ h), (s = 1859775393))
                : r < 60
                ? ((o = (u & l) | (h & (u | l))), (s = 2400959708))
                : ((o = u ^ l ^ h), (s = 3395469782));
              i = (((a << 5) | (a >>> 27)) + o + c + s + n[r]) & 4294967295;
              (c = h),
                (h = l),
                (l = 4294967295 & ((u << 30) | (u >>> 2))),
                (u = a),
                (a = i);
            }
            ...
            if (null != e) {
              ...
              for (
                ...
                if ('string' == typeof e) {
                  for (; r < t; )
                    if (
                      ((i[o] = e.charCodeAt(r)), ++r, ++o === this.blockSize)
                    ) {
      ...
      (t.CONSTANTS = i),
          ...
          for (var t = [], n = 0, r = 0; r < e.length; r++) {
            ...
            if (i >= 55296 && i <= 56319) {
              ...
              o(++r < e.length, 'Surrogate pair missing trail surrogate.'),
                (i = 65536 + (s << 10) + (e.charCodeAt(r) - 56320));
            }
            i < 128
              ? (t[n++] = i)
              : i < 2048
        ...
        (t.validateCallback = function(e, t, n, r) {
          if ((!r || n) && 'function' != typeof n)
            throw new Error(w(e, t, r) + 'must be a valid function.');
        }),
        (t.validateContextObject = function(e, t, n, r) {
          if ((!r || n) && ('object' != typeof n || null === n))
            throw new Error(w(e, t, r) + 'must be a valid context object.');
        }),
        /**
         * @license
         * Copyright 2017 Google Inc.
         ...
         */ (t.validateNamespace = function(e, t, n, r) {
          if ((!r || n) && 'string' != typeof n)
            throw new Error(w(e, t, r) + 'must be a valid firebase namespace.');
        });
    }.call(this, n(11)));
  },
  function(e, t, n) {
    ...
    document.addEventListener('DOMContentLoaded', function() {
      console.debug('---- on load'),
        ...
        new Vue({
          ...
          data: {
            me: null,
            availableRoom: { syncScope: 'global', rooms: [] },
            curRoom: null,
          },
          mounted: function() {
            var e = this;
          ...
          methods: {
            ...
            createRoom: function(e, t) {
              -1 ===
              this.availableRoom.rooms.findIndex(function(t) {
                return t.name === e;
              })
                ? ((this.curRoom = {
                    syncScope: 'room',
                  ...
                  this.addMeAsMember(e, t, !0, !0),
                  r.set(this.availableRoom))
                : console.error('Room with the same name had been existed');
            },
            addMeAsMember: function(e, t, n, i) {
              var o,
                s,
                a,
                u,
                ...
                h,
                c,
                p = (this.curRoom = this.availableRoom.rooms.find(function(t) {
                  return t.name === e;
                }));
              p
                ? -1 ===
                  p.joinedMembers.findIndex(function(e) {
                    return e.name === t;
                  })
                  ? ((this.me =
                      ((s = (o = { name: t, type: i ? 'admin' : void 0 }).name),
                      (a = o.point),
                      (u = void 0 === a ? '0.5h' : a),
                      (l = o.status),
                      (h = void 0 === l ? 'estimating' : l),
                      (c = o.role),
                      {
                        name: s,
                        status: h,
                        point: u,
                        role: void 0 === c ? 'normal' : c,
                      })),
                    p.joinedMembers.push(this.me),
                    n || r.set(this.availableRoom))
                  : console.error(
                      'Member with the same name had been existed',
                      t
                    )
                : console.error('Room with name %s does not exist', e);
            },
            leftRoom: function(e) {},
          },
        });
  ...
  function(e, t, n) {
    (e.exports = n(7)(!1)).push([
      e.i,
      '.mg-t{margin-top:15px}h1,h2{text-align:center}.middle{display:flex;justify-content:center}.float-right{float:right}.mg-r{margin-right:40px}\n',
      '',
    ]);
  },
  function(e, t, n) {
    ...
    function u(e, t) {
      for (var n = 0; n < e.length; n++) {
        ...
        if (o) {
          ...
          for (; s < r.parts.length; s++) o.parts.push(_(r.parts[s], t));
        } else {
          for (var a = []; s < r.parts.length; s++) a.push(_(r.parts[s], t));
  ...
  function(e, t, n) {
    ...
    (function(r) {
      ...
      var i,
        o,
        s =
          (i = n(1)) && 'object' == typeof i && 'default' in i ? i.default : i,
        a = n(0),
        u = n(2),
        l = n(3),
        h = (function() {
        ...
        d = p('localStorage'),
        f = p('sessionStorage'),
        y = new l.Logger('@firebase/database'),
        ...
        m = function() {
          ...
          for (var n = '', r = 0; r < e.length; r++)
            Array.isArray(e[r]) ||
            (e[r] && 'object' == typeof e[r] && 'number' == typeof e[r].length)
              ? (n += m.apply(null, e[r]))
              : 'object' == typeof e[r]
              ? (n += u.stringify(e[r]))
              : (n += e[r]),
        ...
        b = function(e, t) {
          u.assert(
            ...
            !0 === e
              ? ((y.logLevel = l.LogLevel.VERBOSE),
                (C = y.log.bind(y)),
                t && f.set('logging_enabled', !0))
              : 'function' == typeof e
              ? (C = e)
              : ((C = null), f.remove('logging_enabled'));
        },
        w = function() {
          for (var e = [], t = 0; t < arguments.length; t++)
            e[t] = arguments[t];
          if (
            (!0 === E &&
              ((E = !1),
              null === C && !0 === f.get('logging_enabled') && b(!0)),
            C)
          ) {
        ...
        A = function(e, t) {
          ...
          throw new Error(
            'Missing required key (' + e + ') in object: ' + u.stringify(t)
          );
        },
        k = function(e) {
              ...
              : ((t = e < 0),
                (e = Math.abs(e)) >= Math.pow(2, -1022)
                  ? ((n =
                      ...
                      1023),
                    (r = Math.round(e * Math.pow(2, 52 - i) - Math.pow(2, 52))))
                  : ((n = 0), (r = Math.round(e / Math.pow(2, -1074))))),
              s = [],
              o = 52;
            o;
            o -= 1
        ...
        V = (function() {
          ...
          return (
            ...
            (e.prototype.toUrlEncodedString = function() {
              for (var e = '', t = this.pieceNum_; t < this.pieces_.length; t++)
                '' !== this.pieces_[t] &&
                  (e += '/' + encodeURIComponent(String(this.pieces_[t])));
              return e || '/';
            }),
            (e.prototype.slice = function(e) {
              return (
                void 0 === e && (e = 0), this.pieces_.slice(this.pieceNum_ + e)
              );
            }),
            (e.prototype.parent = function() {
              if (this.pieceNum_ >= this.pieces_.length) return null;
              for (
                var t = [], n = this.pieceNum_;
        ...
        H = (function() {
          function e(e, t) {
            ...
            for (var n = 0; n < this.parts_.length; n++)
              this.byteLength_ += u.stringLength(this.parts_[n]);
            this.checkValid_();
          }
          return (
            ...
            (e.prototype.push = function(e) {
              this.parts_.length > 0 && (this.byteLength_ += 1),
                this.parts_.push(e),
                (this.byteLength_ += u.stringLength(e)),
                this.checkValid_();
            }),
        ...
        z = (function() {
          function e(e, t, n, r, i, o) {
            void 0 === i && (i = ''),
              ...
              (this.internalHost = d.get('host:' + e) || this.host);
          }
          return (
            ...
            (e.prototype.updateHost = function(e) {
              e !== this.internalHost &&
                ...
                this.isCacheableHost() &&
                  d.set('host:' + this.host, this.internalHost));
            }),
            (e.prototype.connectionURL = function(e, t) {
              var n;
              if (
                (u.assert('string' == typeof e, 'typeof type must == string'),
                u.assert('object' == typeof t, 'typeof params must == object'),
                'websocket' === e)
              )
                n =
                  (this.secure ? 'wss://' : 'ws://') +
      ...
      var K,
        ...
        Z = function(e) {
          ...
          if ('string' == typeof e) {
            ...
            var d = (function(e) {
              ...
              try {
                for (
                  var i = a.__values(e.split('&')), o = i.next();
                  !o.done;
                  o = i.next()
                ) {
                  var s = o.value;
            ...
            3 === f.length
              ...
              : 2 === f.length
              ? (n = f[0])
              : 'localhost' === f[0].slice(0, h).toLowerCase() &&
                (n = 'localhost'),
              'ns' in d && (o = d.ns);
          }
          return {
        ...
        ie = function(e) {
          return (
            ...
            'string' == typeof e ||
            ('number' == typeof e && !R(e)) ||
            (e && 'object' == typeof e && u.contains(e, '.sv'))
          );
        },
        ...
        se = function(e, t, n) {
          var r = n instanceof V ? new H(n, e) : n;
          if (void 0 === t)
            throw new Error(e + 'contains undefined ' + r.toErrorString());
          ...
          if (R(t))
            throw new Error(
              e + 'contains ' + t.toString() + ' ' + r.toErrorString()
            );
          if (
            'string' == typeof t &&
            t.length > 10485760 / 3 &&
            u.stringLength(t) > 10485760
          )
            throw new Error(
              e +
          ...
          if (t && 'object' == typeof t) {
            ...
            if (
              (L(t, function(t, n) {
                if ('.value' === t) i = !0;
                else if ('.priority' !== t && '.sv' !== t && ((o = !0), !ne(t)))
                  throw new Error(
                    e +
        ...
        ae = function(e, t, n, r, i) {
          if (!i || void 0 !== n) {
            ...
            L(n, function(e, t) {
              var n = new V(e);
              if ((se(o, t, r.child(n)), '.priority' === n.getBack() && !ie(t)))
                throw new Error(
                  o +
        ...
        ye = function(e, t, n, r) {
          if ((!r || void 0 !== n) && 'boolean' != typeof n)
            throw new Error(u.errorPrefix(e, t, r) + 'must be a boolean.');
        },
        _e = (function() {
          function e(e, t) {
          ...
          return (
            (e.prototype.cancel = function(e) {
              u.validateArgCount('OnDisconnect.cancel', 0, 1, arguments.length),
                u.validateCallback('OnDisconnect.cancel', 1, e, !0);
            ...
            (e.prototype.remove = function(e) {
              u.validateArgCount('OnDisconnect.remove', 0, 1, arguments.length),
                de('OnDisconnect.remove', this.path_),
                u.validateCallback('OnDisconnect.remove', 1, e, !0);
              var t = new u.Deferred();
              return (
            ...
            (e.prototype.set = function(e, t) {
              u.validateArgCount('OnDisconnect.set', 1, 2, arguments.length),
                de('OnDisconnect.set', this.path_),
                oe('OnDisconnect.set', 1, e, this.path_, !1),
                u.validateCallback('OnDisconnect.set', 2, t, !0);
            ...
            (e.prototype.setWithPriority = function(e, t, n) {
              u.validateArgCount(
                ...
                de('OnDisconnect.setWithPriority', this.path_),
                oe('OnDisconnect.setWithPriority', 1, e, this.path_, !1),
                ue('OnDisconnect.setWithPriority', 2, t, !1),
                u.validateCallback('OnDisconnect.setWithPriority', 3, n, !0);
            ...
            (e.prototype.update = function(e, t) {
              if (
                ...
                de('OnDisconnect.update', this.path_),
                Array.isArray(e))
              ) {
              ...
              ae('OnDisconnect.update', 1, e, this.path_, !1),
                u.validateCallback('OnDisconnect.update', 2, t, !0);
              var i = new u.Deferred();
              return (
                this.repo_.onDisconnectUpdate(this.path_, e, i.wrapCallback(t)),
                i.promise
              );
            }),
            e
        ...
        ge =
          ...
          function(e) {
            ...
            var r = new Array(8);
            for (t = 7; t >= 0; t--)
              (r[t] = K.charAt(e % 64)), (e = Math.floor(e / 64));
            ...
            return (
              u.assert(20 === i.length, 'nextPushId: Length should be 20.'), i
            );
          }),
        me = (function() {
          function e(e, t) {
        ...
        Ie = function(e) {
          if (e.isLeafNode()) {
            ...
            u.assert(
              'string' == typeof t ||
                'number' == typeof t ||
                ('object' == typeof t && u.contains(t, '.sv')),
              'Priority must be a string or number.'
            );
          } else
            u.assert(e === $ || e.isEmpty(), 'priority of unexpected type.');
          u.assert(
            e === $ || e.getPriority().isEmpty(),
          ...
          return (
            ...
            (e.prototype.hash = function() {
              if (null === this.lazyHash_) {
                ...
                this.priorityNode_.isEmpty() ||
                  (e += 'priority:' + Ne(this.priorityNode_.val()) + ':');
                var t = typeof this.value_;
                (e += t + ':'),
                  (e += 'number' === t ? M(this.value_) : this.value_),
                  (this.lazyHash_ = g(e));
              }
            ...
            (e.prototype.compareTo = function(t) {
              return t === e.__childrenNodeConstructor.EMPTY_NODE
                ...
                ? -1
                : (u.assert(t.isLeafNode(), 'Unknown node type'),
            ...
            (e.prototype.compareToLeafNode_ = function(t) {
              ...
              return (
                u.assert(i >= 0, 'Unknown leaf type: ' + n),
                u.assert(o >= 0, 'Unknown leaf type: ' + r),
                i === o
                  ? 'object' === r
                    ? 0
      ...
      var Pe,
        ...
        Ae = (function() {
          function e(t, n, r, i, o) {
            (this.key = t),
              ...
              (this.left = null != i ? i : Fe.EMPTY_NODE),
              (this.right = null != o ? o : Fe.EMPTY_NODE);
          }
          return (
        ...
        Me = (function() {
          function e(e) {
            var t;
            (this.count = ((t = e + 1), parseInt(Math.log(t) / Le, 10))),
          ...
          var i = function(t, r) {
              ...
              if (1 == a)
                return (
                  (o = e[t]),
                  (s = n ? n(o) : o),
                  new Ae(s, o.node, Ae.BLACK, null, null)
                );
            ...
            o = (function(t) {
              for (
                ...
                var h = t.nextBitIsOne(),
                  c = Math.pow(2, t.count - (l + 1));
                h ? a(c, Ae.BLACK) : (a(c, Ae.BLACK), a(c, Ae.RED));
              }
              return o;
            })(new Me(e.length));
          return new Fe(r || t, o);
        ...
        Qe = (function() {
          ...
          return (
            Object.defineProperty(e, 'Default', {
              get: function() {
                return (
                  u.assert(qe && Oe, 'ChildrenNode.ts has not been loaded'),
                  (Pe = Pe || new e({ '.priority': qe }, { '.priority': Oe }))
                );
              },
              enumerable: !0,
              configurable: !0,
            ...
            (e.prototype.addIndex = function(t, n) {
              ...
              for (
                var r,
                  i = [],
                  o = !1,
                  s = n.getIterator(me.Wrap),
                  l = s.getNext();
                l;

              )
                (o = o || t.isDefinedOn(l.node)), i.push(l), (l = s.getNext());
              r = o ? We(i, t.getCompare()) : qe;
              var h = t.toString(),
                c = a.__assign({}, this.indexSet_);
              c[h] = t;
              var p = a.__assign({}, this.indexes_);
              return (p[h] = r), new e(p, c);
            }),
            (e.prototype.addToIndexes = function(t, n) {
              var r = this;
              return new e(
                u.map(this.indexes_, function(e, i) {
                  var o = u.safeGet(r.indexSet_, i);
                  if (
                    (u.assert(o, 'Missing index implementation for ' + i),
                    e === qe)
                  ) {
                    if (o.isDefinedOn(t.node)) {
                      for (
                        var s = [], a = n.getIterator(me.Wrap), l = a.getNext();
                        l;

                      )
                        l.name != t.name && s.push(l), (l = a.getNext());
                  ...
                  var h = n.get(t.name),
                    c = e;
                  return (
                    h && (c = c.remove(new me(t.name, h))), c.insert(t, t.node)
                  );
                }),
                this.indexSet_
              );
            ...
            (e.prototype.removeFromIndexes = function(t, n) {
              return new e(
                u.map(this.indexes_, function(e) {
                  if (e === qe) return e;
                  var r = n.get(t.name);
       ...
       */ var Ve = (function() {
          ...
          return (
            Object.defineProperty(e, 'EMPTY_NODE', {
              get: function() {
                return De || (De = new e(new Fe(je), null, Qe.Default));
              },
              enumerable: !0,
              configurable: !0,
            }),
            ...
            (e.prototype.getChild = function(e) {
              ...
              return null === t
                ? this
                : this.getImmediateChild(t).getChild(e.popFront());
            }),
            ...
            (e.prototype.updateImmediateChild = function(t, n) {
              if (
                (u.assert(n, 'We should always be passing snapshot nodes'),
                '.priority' === t)
              )
              ...
              return (
                n.isEmpty()
                  ? ((o = this.children_.remove(t)),
                    (s = this.indexMap_.removeFromIndexes(i, this.children_)))
                  : ((o = this.children_.insert(t, n)),
                    (s = this.indexMap_.addToIndexes(i, this.children_))),
                (r = o.isEmpty() ? De : this.priorityNode_),
                new e(o, r, s)
              );
            }),
            (e.prototype.updateChild = function(e, t) {
              ...
              if (null === n) return t;
              u.assert(
                '.priority' !== e.getFront() || 1 === e.getLength(),
                '.priority must be the last token in a path'
              );
            ...
            (e.prototype.val = function(t) {
              ...
              var n = {},
                ...
                o = !0;
              if (
                (this.forEachChild(Oe, function(s, a) {
                  (n[s] = a.val(t)),
                    r++,
                    o && e.INTEGER_REGEXP_.test(s)
            ...
            (e.prototype.hash = function() {
              if (null === this.lazyHash_) {
                var e = '';
                this.getPriority().isEmpty() ||
                  (e += 'priority:' + Ne(this.getPriority().val()) + ':'),
                  this.forEachChild(Oe, function(t, n) {
                    var r = n.hash();
                    '' !== r && (e += ':' + t + ':' + r);
                  }),
            ...
            (e.prototype.getIteratorFrom = function(e, t) {
              ...
              for (
                var r = this.children_.getIteratorFrom(e.name, me.Wrap),
                  i = r.peek();
            ...
            (e.prototype.getReverseIteratorFrom = function(e, t) {
              ...
              for (
                var r = this.children_.getReverseIteratorFrom(e.name, me.Wrap),
                  i = r.peek();
                null != i && t.compare(i, e) > 0;
            ...
            (e.prototype.isIndexed = function(e) {
              return e === be || this.indexMap_.hasIndex(e);
            }),
            (e.prototype.equals = function(e) {
              if (e === this) return !0;
            ...
            (e.prototype.resolveIndex_ = function(e) {
              return e === be ? null : this.indexMap_.get(e.toString());
            }),
        ...
        He = new ((function(e) {
          function t() {
            return e.call(this, new Fe(je), Ve.EMPTY_NODE, Qe.Default) || this;
          }
          return (
            a.__extends(t, e),
      ...
      Object.defineProperties(me, {
        MIN: { value: new me(P, Ve.EMPTY_NODE) },
        MAX: { value: new me(D, He) },
      }),
        (Ee.__EMPTY_NODE = Ve.EMPTY_NODE),
        (Re.__childrenNodeConstructor = Ve),
        ($ = He),
        (function(e) {
          Te = e;
        })(He);
      ...
      var Be = !0;
      function ze(e, t) {
        if ((void 0 === t && (t = null), null === e)) return Ve.EMPTY_NODE;
        if (
        ...
        if (
          (L(e, function(e, t) {
            if ('.' !== e.substring(0, 1)) {
              var n = ze(t);
              n.isEmpty() ||
                ((i = i || !n.getPriority().isEmpty()), r.push(new me(e, n)));
            }
          }),
          0 == r.length)
        )
        ...
        if (i) {
          ...
          return new Ve(
            o,
            ze(t),
            new Qe({ '.priority': s }, { '.priority': Oe })
          );
        }
        return new Ve(o, ze(t), Qe.Default);
      }
      !(function(e) {
        Se = e;
      })(ze);
      ...
      var Ke,
        ...
        Xe = (function(e) {
          ...
          return (
            ...
            (t.prototype.makePost = function(e, t) {
              var n = ze(e),
                r = Ve.EMPTY_NODE.updateChild(this.indexPath_, n);
              return new me(t, r);
            }),
            (t.prototype.maxPost = function() {
              var e = Ve.EMPTY_NODE.updateChild(this.indexPath_, He);
              return new me(D, e);
            }),
            (t.prototype.toString = function() {
        ...
        $e = (function() {
          ...
          return (
            (e.prototype.val = function() {
              return (
                u.validateArgCount('DataSnapshot.val', 0, 0, arguments.length),
                this.node_.val()
              );
            }),
            ...
            (e.prototype.child = function(t) {
              u.validateArgCount('DataSnapshot.child', 0, 1, arguments.length),
                (t = String(t)),
                ce('DataSnapshot.child', 1, t, !1);
              var n = new V(t),
                r = this.ref_.child(n);
            ...
            (e.prototype.hasChild = function(e) {
              u.validateArgCount(
                ...
                ce('DataSnapshot.hasChild', 1, e, !1);
              var t = new V(e);
            ...
            (e.prototype.forEach = function(t) {
              ...
              if (
                ...
                u.validateCallback('DataSnapshot.forEach', 1, t, !1),
            ...
            (e.prototype.getRef = function() {
              return (
                u.validateArgCount('DataSnapshot.ref', 0, 0, arguments.length),
                this.ref_
              );
            }),
          ...
          return (
            ...
            (e.prototype.toString = function() {
              return (
                ...
                this.eventType +
                ':' +
                u.stringify(this.snapshot.exportVal())
              );
            }),
            e
          );
          ...
          return (
            ...
            (e.prototype.createEvent = function(e, t) {
              ...
              return new Je(
                'value',
                this,
                new $e(e.snapshotNode, t.getRef(), n)
              );
            }),
                  ...
                  if (o === i.length) {
                    if (1 === o) {
                      ...
                      return !(
                        ...
                        (t.callbacks_[s] &&
                          this.callbacks_[a] &&
                          t.callbacks_[s] !== this.callbacks_[a])
                      );
                    }
          ...
          return (
            ...
            (e.validateQueryEndpoints_ = function(e) {
              ...
              if (
                ...
                (u.assert(
                  e.getIndex() instanceof Xe || e.getIndex() === Ge,
                  'unknown index type.'
                ),
            ...
            (e.prototype.getRef = function() {
              return (
                u.validateArgCount('Query.ref', 0, 0, arguments.length),
                new e.__referenceConstructor(this.repo, this.path)
              );
            }),
            (e.prototype.on = function(t, n, r, i) {
              u.validateArgCount('Query.on', 2, 4, arguments.length),
                le('Query.on', 1, t, !1),
                u.validateCallback('Query.on', 2, n, !1);
            ...
            (e.prototype.off = function(e, t, n) {
              u.validateArgCount('Query.off', 0, 3, arguments.length),
                le('Query.off', 1, e, !0),
                u.validateCallback('Query.off', 2, t, !0),
                u.validateContextObject('Query.off', 3, n, !0);
              var r = null,
                i = null;
              if ('value' === e) {
                var o = t || null;
                ...
                e && (t && ((i = {})[e] = t), (r = new tt(i, null, n || null)));
              this.repo.removeEventCallbackForQuery(this, r);
            }),
            (e.prototype.once = function(t, n, r, i) {
              var o = this;
              u.validateArgCount('Query.once', 1, 4, arguments.length),
                le('Query.once', 1, t, !1),
                u.validateCallback('Query.once', 2, n, !0);
              ...
              var h = function(e) {
                a &&
                  ((a = !1),
                  o.off(t, h),
                  n && n.bind(s.context)(e),
                  l.resolve(e));
              };
              return (
                this.on(t, h, function(e) {
                  o.off(t, h),
                    s.cancel && s.cancel.bind(s.context)(e),
                    l.reject(e);
                }),
                l.promise
              );
            ...
            (e.prototype.orderByChild = function(t) {
              ...
              return (
                e.validateQueryEndpoints_(i), new e(this.repo, this.path, i, !0)
              );
            }),
            (e.prototype.orderByKey = function() {
              u.validateArgCount('Query.orderByKey', 0, 0, arguments.length),
                this.validateNoPreviousOrderByCall_('Query.orderByKey');
              var t = this.queryParams_.orderBy(be);
              return (
                e.validateQueryEndpoints_(t), new e(this.repo, this.path, t, !0)
              );
            }),
            ...
            (e.prototype.orderByValue = function() {
              u.validateArgCount('Query.orderByValue', 0, 0, arguments.length),
            ...
            (e.prototype.startAt = function(t, n) {
              void 0 === t && (t = null),
                u.validateArgCount('Query.startAt', 0, 2, arguments.length),
                oe('Query.startAt', 1, t, this.path, !0),
                he('Query.startAt', 2, n, !0);
              ...
              return (
                void 0 === t && ((t = null), (n = null)),
                new e(this.repo, this.path, r, this.orderByCalled_)
              );
            }),
            (e.prototype.endAt = function(t, n) {
              void 0 === t && (t = null),
                u.validateArgCount('Query.endAt', 0, 2, arguments.length),
                oe('Query.endAt', 1, t, this.path, !0),
                he('Query.endAt', 2, n, !0);
            ...
            (e.prototype.equalTo = function(e, t) {
              if (
                (u.validateArgCount('Query.equalTo', 1, 2, arguments.length),
                oe('Query.equalTo', 1, e, this.path, !1),
                he('Query.equalTo', 2, t, !0),
                this.queryParams_.hasStart())
              )
                throw new Error(
            ...
            (e.prototype.toString = function() {
              return (
                u.validateArgCount('Query.toString', 0, 0, arguments.length),
                this.repo.toString() + this.path.toUrlEncodedString()
              );
            }),
            (e.prototype.toJSON = function() {
              return (
                u.validateArgCount('Query.toJSON', 0, 1, arguments.length),
                this.toString()
              );
            }),
            ...
            (e.prototype.isEqual = function(t) {
              if (
                (u.validateArgCount('Query.isEqual', 1, 1, arguments.length),
                !(t instanceof e))
              ) {
                var n =
            ...
            (e.getCancelAndContextArgs_ = function(e, t, n) {
              ...
              if (t && n)
                (r.cancel = t),
                  u.validateCallback(e, 3, r.cancel, !0),
                  (r.context = n),
                  u.validateContextObject(e, 4, r.context, !0);
              else if (t)
          ...
          return (
            (e.prototype.find = function(e) {
              ...
              if (!e.isEmpty() && this.children.size > 0) {
                ...
                return (
                  (e = e.popFront()),
                  this.children.has(t) ? this.children.get(t).find(e) : null
                );
              }
              return null;
            }),
            ...
            (e.prototype.forget = function(e) {
              ...
              if (null !== this.value) {
                ...
                var n = this;
                return (
                  t.forEachChild(Oe, function(e, t) {
        ...
        ot = function(e, t) {
          ...
          return (
            (n = a),
            i !== a.getPriority().val() && (n = n.updatePriority(new Re(i))),
            a.forEachChild(Oe, function(e, r) {
              var i = ot(r, t);
      ...
      var st,
        ...
        ut = (function() {
          function e(e, t, n, r) {
            (this.fromUser = e),
              ...
              (this.queryId = n),
              (this.tagged = r),
              u.assert(!r || t, 'Tagged queries must be from server.');
          }
          return (
        ...
        ht = function() {
          return st || (st = new Fe(x)), st;
        },
        ct = (function() {
          function e(e, t) {
            void 0 === t && (t = ht()), (this.value = e), (this.children = t);
          }
          return (
            ...
            (e.prototype.foreachOnPath_ = function(t, n, r) {
              ...
              var i = t.getFront(),
                o = this.children.get(i);
              return o
                ? o.foreachOnPath_(t.popFront(), n.child(i), r)
                : e.Empty;
            }),
        ...
        dt = (function() {
          ...
          return (
            (e.prototype.operationForChild = function(t) {
              return this.path.isEmpty()
                ? new e(this.source, V.Empty, this.snap.getImmediateChild(t))
                : new e(this.source, this.path.popFront(), this.snap);
            }),
            e
          );
        })(),
            ...
            (e.prototype.operationForChild = function(t) {
              if (this.path.isEmpty()) {
                ...
                return n.isEmpty()
                  ? null
                  : n.value
                  ? new dt(this.source, V.Empty, n.value)
                  : new e(this.source, V.Empty, n);
              }
              return (
                u.assert(
                  this.path.getFront() === t,
        ...
        _t = (function() {
          ...
          return (
            (e.prototype.updateEventSnap = function(t, n, r) {
              return new e(new yt(t, n, r), this.serverCache_);
            }),
            (e.prototype.updateServerSnap = function(t, n, r) {
              return new e(this.eventCache_, new yt(t, n, r));
            }),
          ...
          return (
            (e.prototype.updateChild = function(e, t, n, r, i, o) {
              ...
              return s.getChild(r).equals(n.getChild(r)) &&
                ...
                : (null != o &&
                    (n.isEmpty()
                      ? e.hasChild(t)
                        ? o.trackChildChange(vt.childRemovedChange(t, s))
                        : u.assert(
                            e.isLeafNode(),
                            'A child remove without an old child only makes sense on a leaf node'
                          )
                      : s.isEmpty()
                      ? o.trackChildChange(vt.childAddedChange(t, n))
                      : o.trackChildChange(vt.childChangedChange(t, n, s))),
            ...
            (e.prototype.updateFullNode = function(e, t, n) {
              return (
                null != n &&
                  (e.isLeafNode() ||
                    e.forEachChild(Oe, function(e, r) {
                      t.hasChild(e) ||
                        n.trackChildChange(vt.childRemovedChange(e, r));
                    }),
                  t.isLeafNode() ||
                    t.forEachChild(Oe, function(t, r) {
                      if (e.hasChild(t)) {
                        var i = e.getImmediateChild(t);
                        i.equals(r) ||
                          n.trackChildChange(vt.childChangedChange(t, r, i));
            ...
            (e.prototype.updatePriority = function(e, t) {
              return e.isEmpty() ? Ve.EMPTY_NODE : e.updatePriority(t);
            }),
        ...
        mt = (function() {
          ...
          return (
            (e.prototype.trackChildChange = function(e) {
              ...
              if (r) {
                var i = r.type;
                if (t == vt.CHILD_ADDED && i == vt.CHILD_REMOVED)
                  this.changeMap.set(
                    n,
                    vt.childChangedChange(n, e.snapshotNode, r.snapshotNode)
                  );
                else if (t == vt.CHILD_REMOVED && i == vt.CHILD_ADDED)
                  this.changeMap.delete(n);
                else if (t == vt.CHILD_REMOVED && i == vt.CHILD_CHANGED)
                  this.changeMap.set(n, vt.childRemovedChange(n, r.oldSnap));
                else if (t == vt.CHILD_CHANGED && i == vt.CHILD_ADDED)
                  this.changeMap.set(n, vt.childAddedChange(n, e.snapshotNode));
                else {
                  if (t != vt.CHILD_CHANGED || i != vt.CHILD_CHANGED)
                    throw u.assertionError(
                  ...
                  this.changeMap.set(
                    n,
                    vt.childChangedChange(n, e.snapshotNode, r.oldSnap)
                  );
                }
            ...
            (e.prototype.getCompleteChild = function(e) {
              ...
              var n =
                null != this.optCompleteServerCache_
                  ? new yt(this.optCompleteServerCache_, !0, !1)
          ...
          return (
            ...
            (e.prototype.applyOperation = function(t, n, r, i) {
              ...
              if (n.type === Ye.OVERWRITE) {
                var l = n;
                l.source.fromUser
                  ? (o = this.applyUserOverwrite_(t, l.path, l.snap, r, i, a))
                  : (u.assert(l.source.fromServer, 'Unknown source.'),
                    (s =
                      l.source.tagged ||
                      (t.getServerCache().isFiltered() && !l.path.isEmpty())),
                ...
                var h = n;
                h.source.fromUser
                  ? (o = this.applyUserMerge_(t, h.path, h.children, r, i, a))
                  : (u.assert(h.source.fromServer, 'Unknown source.'),
                    (s = h.source.tagged || t.getServerCache().isFiltered()),
                ...
                var c = n;
                o = c.revert
                  ? this.revertUserWrite_(t, c.path, r, i, a)
                  : this.ackUserWrite_(t, c.path, c.affectedTree, r, i, a);
              } else {
                if (n.type !== Ye.LISTEN_COMPLETE)
                  throw u.assertionError('Unknown operation type: ' + n.type);
                o = this.listenComplete_(t, n.path, r, a);
              }
              var p = a.getChanges();
              return e.maybeAddValueEvent_(t, o, p), new bt(o, p);
            }),
            (e.maybeAddValueEvent_ = function(e, t, n) {
              ...
              if (r.isFullyInitialized()) {
                ...
                (n.length > 0 ||
                  !e.getEventCache().isFullyInitialized() ||
                  (i && !r.getNode().equals(o)) ||
                  !r
                    .getNode()
                    .getPriority()
                    .equals(o.getPriority())) &&
                  n.push(vt.valueChange(t.getCompleteEventSnap()));
              }
            }),
            (e.prototype.generateEventCacheAfterServerEvent_ = function(
              e,
              t,
              n,
              r,
              ...
              if (t.isEmpty())
                ...
                if ('.priority' == d) {
                  ...
                  var y = n.calcEventCacheAfterServerOverwrite(t, f, a);
                  s =
                    null != y ? this.filter_.updatePriority(f, y) : o.getNode();
                } else {
                  var _ = t.popFront(),
                    v = void 0;
                  ...
                  s =
                    null != v
                      ? this.filter_.updateChild(o.getNode(), d, v, _, r, i)
                      : o.getNode();
                }
              }
              return e.updateEventSnap(
                s,
                o.isFullyInitialized() || t.isEmpty(),
            ...
            (e.prototype.applyServerOverwrite_ = function(e, t, n, r, i, o, s) {
              ...
              if (t.isEmpty()) a = l.updateFullNode(u.getNode(), n, null);
                ...
                a =
                  '.priority' == c
                    ? l.updatePriority(u.getNode(), d)
                    : l.updateChild(u.getNode(), c, d, p, Ct, null);
              }
              var f = e.updateServerSnap(
                  a,
                  u.isFullyInitialized() || t.isEmpty(),
                  l.filtersNodes()
                ),
                y = new Et(r, f, i);
              return this.generateEventCacheAfterServerEvent_(f, t, r, y, s);
            }),
            (e.prototype.applyUserOverwrite_ = function(e, t, n, r, i, o) {
              ...
              if (t.isEmpty())
                (a = this.filter_.updateFullNode(
                  ...
                  (s = e.updateEventSnap(a, !0, this.filter_.filtersNodes()));
              else {
                var h = t.getFront();
                if ('.priority' === h)
            ...
            (e.prototype.applyUserMerge_ = function(t, n, r, i, o, s) {
              ...
              return (
                r.foreach(function(r, l) {
                  var h = n.child(r);
                  e.cacheHasChild_(t, h.getFront()) &&
                    (u = a.applyUserOverwrite_(u, h, l, i, o, s));
                }),
                r.foreach(function(r, l) {
                  var h = n.child(r);
                  e.cacheHasChild_(t, h.getFront()) ||
            ...
            (e.prototype.applyServerMerge_ = function(e, t, n, r, i, o, s) {
              ...
              var h = e.getServerCache().getNode();
              return (
                u.children.inorderTraversal(function(t, n) {
                  if (h.hasChild(t)) {
                    var u = e
                        ...
                        .getImmediateChild(t),
                      c = a.applyMerge_(u, n);
                    l = a.applyServerOverwrite_(l, new V(t), c, r, i, o, s);
                  }
                }),
                u.children.inorderTraversal(function(t, n) {
                  var u =
                    !e.getServerCache().isCompleteForChild(t) &&
                    null == n.value;
                  if (!h.hasChild(t) && !u) {
                    var c = e
                        .getServerCache()
                        ...
                        .getImmediateChild(t),
                      p = a.applyMerge_(c, n);
                    l = a.applyServerOverwrite_(l, new V(t), p, r, i, o, s);
                  }
                }),
                l
              );
            ...
            (e.prototype.ackUserWrite_ = function(e, t, n, r, i, o) {
              ...
              if (null != n.value) {
                if (
                  (t.isEmpty() && a.isFullyInitialized()) ||
                  a.isCompleteForPath(t)
                )
                  return this.applyServerOverwrite_(
                    e,
                    t,
                    a.getNode().getChild(t),
                    r,
                    i,
                    s,
                    o
                ...
                if (t.isEmpty()) {
                  var u = ct.Empty;
                  return (
                    a.getNode().forEachChild(be, function(e, t) {
                      u = u.set(new V(e), t);
                    }),
              ...
              return (
                n.foreach(function(e, n) {
                  ...
                  a.isCompleteForPath(r) &&
                    (l = l.set(e, a.getNode().getChild(r)));
                }),
                this.applyServerMerge_(e, t, l, r, i, s, o)
              );
            }),
            (e.prototype.listenComplete_ = function(e, t, n, r) {
              var i = e.getServerCache(),
                o = e.updateServerSnap(
                  i.getNode(),
                  i.isFullyInitialized() || t.isEmpty(),
                  i.isFiltered()
                );
            ...
            (e.prototype.revertUserWrite_ = function(e, t, n, r, i) {
              ...
              if (t.isEmpty() || '.priority' === t.getFront()) {
                ...
                if (e.getServerCache().isFullyInitialized())
                  h = n.calcCompleteEventCache(e.getCompleteServerSnap());
                else {
                ...
                (h = h), (l = this.filter_.updateFullNode(a, h, i));
              } else {
                var p = t.getFront(),
                  d = n.calcCompleteChild(p, e.getServerCache());
                null == d &&
                  e.getServerCache().isCompleteForChild(p) &&
                  (d = a.getImmediateChild(p)),
                  (l =
                    null != d
                      ? this.filter_.updateChild(a, p, d, t.popFront(), s, i)
                      : e
                          .getEventCache()
                          .getNode()
                          .hasChild(p)
                    ...
                    (l = this.filter_.updateFullNode(l, o, i));
              }
              return (
                (o =
                  e.getServerCache().isFullyInitialized() ||
                  null != n.shadowingWrite(V.Empty)),
                e.updateEventSnap(l, o, this.filter_.filtersNodes())
              );
            }),
            e
          );
          ...
          return (
            (e.prototype.generateEventsForChanges = function(e, t, n) {
              ...
              return (
                e.forEach(function(e) {
                  e.type === vt.CHILD_CHANGED &&
                    r.index_.indexedValueChanged(e.oldSnap, e.snapshotNode) &&
                    o.push(vt.childMovedChange(e.childName, e.snapshotNode));
                }),
                this.generateEventsForType_(i, vt.CHILD_REMOVED, e, n, t),
            ...
            (e.prototype.compareChanges_ = function(e, t) {
              if (null == e.childName || null == t.childName)
                throw u.assertionError('Should only compare child_ events.');
        ...
        Tt = (function() {
          function e(e, t) {
            ...
            var n = this.query_.getQueryParams(),
              r = new gt(n.getIndex()),
              i = n.getNodeFilter();
            this.processor_ = new wt(i);
            var o = t.getServerCache(),
              s = t.getEventCache(),
              a = r.updateFullNode(Ve.EMPTY_NODE, o.getNode(), null),
              u = i.updateFullNode(Ve.EMPTY_NODE, s.getNode(), null),
              l = new yt(a, o.isFullyInitialized(), r.filtersNodes()),
              h = new yt(u, s.isFullyInitialized(), i.filtersNodes());
            (this.viewCache_ = new _t(h, l)),
              (this.eventGenerator_ = new St(this.query_));
          }
          return (
            ...
            (e.prototype.getCompleteServerCache = function(e) {
              ...
              return t &&
                (this.query_.getQueryParams().loadsAllData() ||
                  (!e.isEmpty() &&
                    !t.getImmediateChild(e.getFront()).isEmpty()))
                ? t.getChild(e)
                : null;
            }),
            (e.prototype.isEmpty = function() {
            ...
            (e.prototype.getInitialEvents = function(e) {
              ...
              t.getNode().isLeafNode() ||
                t.getNode().forEachChild(Oe, function(e, t) {
                  n.push(vt.childAddedChange(e, t));
                });
              return (
                t.isFullyInitialized() && n.push(vt.valueChange(t.getNode())),
          ...
          return (
            ...
            (e.prototype.applyOperation = function(e, t, n) {
              ...
              if (null !== o) {
                ...
                return (
                  ...
                  s.applyOperation(e, t, n)
                );
              }
              var l = [];
              try {
                for (
                  var h = a.__values(this.views.values()), c = h.next();
                  !c.done;
                  c = h.next()
                ) {
                  s = c.value;
                  l = l.concat(s.applyOperation(e, t, n));
                }
              } catch (e) {
                r = { error: e };
              } finally {
            ...
            (e.prototype.addEventRegistration = function(e, t, n, r, i) {
              ...
              if (!s) {
                ...
                a
                  ...
                  : ((a = Ve.EMPTY_NODE), (u = !1));
                var l = new _t(new yt(a, u, !1), new yt(r, i, !1));
                (s = new Tt(e, l)), this.views.set(o, s);
              }
            ...
            (e.prototype.removeEventRegistration = function(t, n, r) {
              ...
              if ('default' === s)
                try {
                  for (
                    var c = a.__values(this.views.entries()), p = c.next();
                    !p.done;
                    p = c.next()
                  ) {
                    var d = a.__read(p.value, 2),
                      f = d[0],
                      y = d[1];
                    (l = l.concat(y.removeEventRegistration(n, r))),
                      y.isEmpty() &&
                        (this.views.delete(f),
                        y
                          .getQuery()
              ...
              return (
                h &&
                  ...
                  u.push(new e.__referenceConstructor(t.repo, t.path)),
                { removed: u, events: l }
              );
            }),
            (e.prototype.getQueryViews = function() {
              ...
              try {
                for (
                  var r = a.__values(this.views.values()), i = r.next();
                  !i.done;
                  i = r.next()
                ) {
                  var o = i.value;
            ...
            (e.prototype.getCompleteServerCache = function(e) {
              ...
              try {
                for (
                  var i = a.__values(this.views.values()), o = i.next();
                  !o.done;
                  o = i.next()
                ) {
                  var s = o.value;
            ...
            (e.prototype.getCompleteView = function() {
              ...
              try {
                for (
                  var n = a.__values(this.views.values()), r = n.next();
                  !r.done;
                  r = n.next()
                ) {
                  var i = r.value;
          ...
          return (
            (e.prototype.addWrite = function(t, n) {
              ...
              if (null != r) {
                var i = r.path,
                  o = r.value,
                  s = V.relativePath(i, t);
                return (
                  (o = o.updateChild(s, n)), new e(this.writeTree_.set(i, o))
                );
              }
              var a = new ct(n);
            ...
            (e.prototype.removeWrite = function(t) {
              return t.isEmpty()
                ? e.Empty
                : new e(this.writeTree_.setTree(t, ct.Empty));
            }),
            ...
            (e.prototype.getCompleteNode = function(e) {
              ...
              return null != t
                ? this.writeTree_
                    .get(t.path)
                    .getChild(V.relativePath(t.path, e))
                : null;
            }),
            (e.prototype.getCompleteChildren = function() {
              ...
              return (
                null != t
                  ? t.isLeafNode() ||
                    t.forEachChild(Oe, function(t, n) {
                      e.push(new me(t, n));
                    })
              ...
              return (function e(t, n, r) {
                ...
                return (
                  ...
                  r.getChild(t).isEmpty() ||
                    null === i ||
                    (r = r.updateChild(t.child('.priority'), i)),
                  r
                );
              })(
                /**
       ...
       */ var Rt = (function() {
          ...
          return (
            ...
            (e.prototype.calcCompleteEventChildren = function(e, t) {
              ...
              if (r)
                return (
                  r.isLeafNode() ||
                    r.forEachChild(Oe, function(e, t) {
            ...
            (e.prototype.calcEventCacheAfterServerOverwrite = function(
              e,
              t,
              n,
              r
            ...
            (e.prototype.calcCompleteChild = function(e, t, n) {
              ...
              return null != i
                ...
                ? this.visibleWrites_
                    ...
                    .apply(n.getNode().getImmediateChild(t))
                : null;
            }),
            ...
            (e.prototype.calcIndexedSlice = function(e, t, n, r, i, o) {
              var s,
                a = this.visibleWrites_.childCompoundWrite(e),
            ...
            (e.prototype.resetTree_ = function() {
              (this.visibleWrites_ = e.layerTree_(
                this.allWrites_,
                e.DefaultFilter_,
                V.Empty
              )),
                ...
                if (t(o)) {
                  ...
                  if (o.snap)
                    ...
                    if (n.contains(s))
                      ...
                      if ((a = V.relativePath(s, n)).isEmpty())
                        r = r.addWrites(V.Empty, o.children);
                      else {
                        var l = u.safeGet(o.children, a.getFront());
                        if (l) {
                          var h = l.getChild(a.popFront());
                          r = r.addWrite(V.Empty, h);
                        }
                      }
                  }
                }
        ...
        Dt = (function() {
          function e(e) {
            (this.listenProvider_ = e),
              (this.syncPointTree_ = ct.Empty),
              (this.pendingWriteTree_ = new Rt()),
          ...
          return (
            (e.prototype.applyUserOverwrite = function(e, t, n, r) {
              return (
                ...
                r ? this.applyOperationToSyncPoints_(new dt(ut.User, e, t)) : []
              );
            }),
            ...
            (e.prototype.ackUserWrite = function(e, t) {
              ...
              if (this.pendingWriteTree_.removeWrite(e)) {
                ...
                return (
                  null != n.snap
                    ? (r = r.set(V.Empty, !0))
                    : L(n.children, function(e, t) {
                        r = r.set(new V(e), t);
                      }),
                  this.applyOperationToSyncPoints_(new lt(n.path, r, t))
                );
              }
              return [];
            }),
            ...
            (e.prototype.applyTaggedQueryOverwrite = function(t, n, r) {
              ...
              if (null != i) {
                var o = e.parseQueryKey_(i),
                  s = o.path,
                  a = o.queryId,
                  u = V.relativePath(s, t),
                  l = new dt(ut.forServerTaggedQuery(a), u, n);
            ...
            (e.prototype.applyTaggedQueryMerge = function(t, n, r) {
              ...
              if (i) {
                var o = e.parseQueryKey_(i),
                  ...
                  u = V.relativePath(s, t),
                  l = ct.fromObject(n),
                  h = new ft(ut.forServerTaggedQuery(a), u, l);
            ...
            (e.prototype.addEventRegistration = function(t, n) {
              ...
              this.syncPointTree_.foreachOnPath(r, function(e, t) {
                ...
                (i = i || t.getCompleteServerCache(n)),
                  (o = o || t.hasCompleteView());
              });
              var s,
                a = this.syncPointTree_.get(r);
              (a
                ? ((o = o || a.hasCompleteView()),
                  (i = i || a.getCompleteServerCache(V.Empty)))
                : ((a = new Nt()),
              ...
              null != i)
                ...
                : ((s = !1),
                  (i = Ve.EMPTY_NODE),
                  this.syncPointTree_.subtree(r).foreachChild(function(e, t) {
                    var n = t.getCompleteServerCache(V.Empty);
                    n && (i = i.updateImmediateChild(e, n));
                  }));
              var l = a.viewExistsForQuery(t);
              if (!l && !t.getQueryParams().loadsAllData()) {
                ...
                this.queryToTagMap.set(h, c), this.tagToQueryMap.set(c, h);
              }
            ...
            (e.prototype.removeEventRegistration = function(t, n, r) {
              ...
              if (
                s &&
                ('default' === t.queryIdentifier() || s.viewExistsForQuery(t))
              ) {
                ...
                if (h && !c) {
                  ...
                  if (!p.isEmpty())
                    for (
                      ...
                      var y = d[f],
                        _ = y.getQuery(),
                        v = this.createListenerForView_(y);
                      this.listenProvider_.startListening(
                        e.queryForListening_(_),
                        this.tagForQuery_(_),
                        v.hashFn,
                        v.onComplete
                      );
                ...
                for (
                  var l = a.fold(function(e, t, n) {
                      ...
                      return (
                        t &&
                          (r = r.concat(
                            t.getQueryViews().map(function(e) {
                              return e.getQuery();
                            })
                          )),
                        L(n, function(e, t) {
            ...
            (e.prototype.createListenerForView_ = function(e) {
              ...
              return {
                hashFn: function() {
                  return (e.getServerCache() || Ve.EMPTY_NODE).hash();
                },
                onComplete: function(e) {
                  if ('ok' === e)
                    return r
                      ? t.applyTaggedListenComplete(n.path, r)
                      : t.applyListenComplete(n.path);
                  var i = (function(e, t) {
                    var n = 'Unknown Error';
                    'too_big' === e
                      ? (n =
            ...
            (e.parseQueryKey_ = function(e) {
              var t = e.indexOf('$');
              return (
                u.assert(-1 !== t && t < e.length - 1, 'Bad queryKey.'),
                { queryId: e.substr(t + 1), path: new V(e.substr(0, t)) }
              );
            }),
            ...
            (e.prototype.applyOperationDescendantsHelper_ = function(
              ...
              return (
                t.children.inorderTraversal(function(t, o) {
                  ...
                  l &&
                    (s = s.concat(
                      i.applyOperationDescendantsHelper_(l, o, a, u)
                    ));
                }),
                o && (s = s.concat(o.applyOperation(e, r, n))),
                s
              );
            }),
            (e.nextQueryTag_ = 1),
        ...
        kt = (function() {
          ...
          return (
            (e.prototype.getToken = function(e) {
              return Promise.resolve(new At('owner'));
            }),
            (e.prototype.addTokenChangeListener = function(e) {}),
            (e.prototype.removeTokenChangeListener = function(e) {}),
            (e.prototype.notifyForInvalidToken = function() {
        ...
        Ft = (function() {
          ...
          return (
            (e.prototype.incrementCounter = function(e, t) {
              void 0 === t && (t = 1),
                u.contains(this.counters_, e) || (this.counters_[e] = 0),
                (this.counters_[e] += t);
            }),
        ...
        Lt = (function() {
          ...
          return (
            (e.getCollection = function(e) {
              var t = e.toString();
              return (
                this.collections_[t] || (this.collections_[t] = new Ft()),
                this.collections_[t]
              );
            }),
          ...
          return (
            (e.prototype.queueEvents = function(e) {
              for (var t = null, n = 0; n < e.length; n++) {
                ...
                null === t ||
                  i.equals(t.getPath()) ||
                  (this.eventLists_.push(t), (t = null)),
                  null === t && (t = new jt(i)),
                  t.add(r);
              }
          ...
          return (
            (e.prototype.trigger = function(e) {
              ...
              if (Array.isArray(this.listeners_[e]))
                for (
                  var r = a.__spread(this.listeners_[e]), i = 0;
                  i < r.length;
                  i++
                )
        ...
        Ht = (function(e) {
          ...
          return (
            ...
            (t.prototype.getInitialEvent = function(e) {
              return (
                u.assert('visible' === e, 'Unknown event type: ' + e),
                [this.visible_]
              );
            }),
            t
        ...
        Bt = (function(e) {
          ...
          return (
            ...
            (t.prototype.getInitialEvent = function(e) {
              return (
                u.assert('online' === e, 'Unknown event type: ' + e),
                [this.online_]
              );
            }),
        ...
        Gt = (function() {
          function e(e, t, n, r) {
            (this.connId = e),
              ...
              (this.log_ = S(e)),
              (this.stats_ = Lt.getCollection(t)),
          ...
          return (
            ...
            (e.prototype.send = function(e) {
              ...
              for (
                var n = u.base64Encode(t), r = F(n, 1840), i = 0;
                i < r.length;
                i++
              )
          ...
          function e(t, n, r, i) {
            if (
              ...
              (this.uniqueCallbackIdentifier = v()),
                (window[Kt + this.uniqueCallbackIdentifier] = t),
                (window[Yt + this.uniqueCallbackIdentifier] = n),
                ...
                : setTimeout(function() {
                    try {
                      ...
                      (r.type = 'text/javascript'),
                        ...
                        (r.onerror = function() {
                          w('Long-poll script failed to load: ' + e),
                            (n.sendNewPolls = !1),
                            n.close();
                        }),
      ...
      'undefined' != typeof MozWebSocket
        ? (Jt = MozWebSocket)
        : 'undefined' != typeof WebSocket && (Jt = WebSocket);
      var Zt = (function() {
          function e(t, n, r, i) {
            (this.connId = t),
              ...
              (this.bytesSent = 0),
              (this.bytesReceived = 0),
              (this.log_ = S(this.connId)),
              (this.stats_ = Lt.getCollection(n)),
          ...
          return (
            ...
            (e.previouslyFailed = function() {
              return (
                d.isInMemoryStorage ||
                !0 === d.get('previous_websocket_failure')
              );
            }),
            (e.prototype.markConnectionHealthy = function() {
          ...
          return (
            ...
            (e.prototype.initTransports_ = function(t) {
              ...
              if (
                ...
                try {
                  for (
                    var u = a.__values(e.ALL_TRANSPORTS), l = u.next();
                    !l.done;
                    l = u.next()
                  ) {
                    var h = l.value;
                    h && h.isAvailable() && s.push(h);
                  }
                } catch (e) {
                  n = { error: e };
                } finally {
        ...
        tn = (function() {
          function e(e, t, n, r, i, o, s) {
            (this.id = e),
              ...
              (this.state_ = 0),
              (this.log_ = S('c:' + this.id + ':')),
              (this.transportManager_ = new en(t)),
              ...
              if ('d' in e) {
                ...
                if ('h' === t) this.onHandshake_(n);
                  ...
                  's' === t
                    ...
                    : T('Unknown control packet command: ' + t);
              }
            }),
        ...
        sn = (function(e) {
          function t(n, r, i, o, s, a) {
            ...
            if (
              ((l.repoInfo_ = n),
              (l.onDataUpdate_ = r),
              (l.onConnectStatus_ = i),
              (l.onServerInfoUpdate_ = o),
              (l.authTokenProvider_ = s),
              (l.authOverride_ = a),
              (l.id = t.nextPersistentConnectionId_++),
              (l.log_ = S('p:' + l.id + ':')),
              (l.interruptReasons_ = {}),
              (l.listens = new Map()),
              (l.outstandingPuts_ = []),
              (l.outstandingPutCount_ = 0),
              (l.onDisconnectRequestQueue_ = []),
              (l.connected_ = !1),
              (l.reconnectDelay_ = rn),
              (l.maxReconnectDelay_ = on),
              (l.securityDebugCallback_ = null),
              (l.lastSessionId = null),
              (l.establishConnectionTimer_ = null),
              (l.visible_ = !1),
              (l.requestCBHash_ = {}),
              (l.requestNumber_ = 0),
              (l.realtime_ = null),
              (l.authToken_ = null),
              (l.forceTokenRefresh_ = !1),
              (l.invalidAuthTokenCount_ = 0),
              (l.firstConnection_ = !0),
              (l.lastConnectionAttemptTime_ = null),
              (l.lastConnectionEstablishedTime_ = null),
              a && !u.isNodeSdk())
            )
              throw new Error(
            ...
            return (
              l.scheduleConnect_(0),
              Ht.getInstance().on('visible', l.onVisible_, l),
              -1 === n.host.indexOf('fblocal') &&
                Bt.getInstance().on('online', l.onOnline_, l),
              l
            );
          }
          return (
            ...
            (t.prototype.listen = function(e, t, n, r) {
              ...
              var s = { onComplete: r, hashFn: t, query: e, tag: n };
            ...
            (t.prototype.sendListen_ = function(e) {
              ...
              var s = { p: i };
              e.tag && ((s.q = r.queryObject()), (s.t = e.tag)),
                (s.h = e.hashFn()),
                this.sendRequest('q', s, function(s) {
                  var a = s.d,
                    u = s.s;
                  t.warnOnListenWarnings_(a, r),
                    (n.listens.get(i) && n.listens.get(i).get(o)) === e &&
                  ...
                  this.authTokenProvider_
                    ...
                    .then(null, function(e) {
                      o.log_('Failed to get token: ' + e),
                        a || (u.CONSTANTS.NODE_ADMIN && I(e), h());
                    });
              }
            }),
            (t.prototype.interrupt = function(e) {
              w('Interrupting connection for reason: ' + e),
            ...
            (t.prototype.resume = function(e) {
              w('Resuming connection for reason: ' + e),
                delete this.interruptReasons_[e],
                u.isEmpty(this.interruptReasons_) &&
                  ((this.reconnectDelay_ = rn),
                  this.realtime_ || this.scheduleConnect_(0));
            }),
            ...
            (t.prototype.restoreState_ = function() {
              ...
              try {
                for (
                  var i = a.__values(this.listens.values()), o = i.next();
                  !o.done;
                  o = i.next()
                ) {
                  var s = o.value;
                  try {
                    for (
                      var u = ((n = void 0), a.__values(s.values())),
                        l = u.next();
                      !l.done;
                      l = u.next()
                    ) {
            ...
            (t.prototype.sendConnectStats_ = function() {
              var e = {},
                t = 'js';
              u.CONSTANTS.NODE_ADMIN
                ? (t = 'admin_node')
                : u.CONSTANTS.NODE_CLIENT && (t = 'node'),
                (e['sdk.' + t + '.' + $t.replace(/\./g, '-')] = 1),
                u.isMobileCordova()
                  ? (e['framework.cordova'] = 1)
                  : u.isReactNative() && (e['framework.reactnative'] = 1),
                this.reportStats(e);
            }),
        ...
        an = (function(e) {
          ...
          return (
            ...
            (t.prototype.listen = function(e, n, r, i) {
              ...
              this.restRequest_(s + '.json', h, function(e, t) {
                var n = t;
                (404 === e && ((n = null), (e = null)),
                null === e && o.onDataUpdate_(s, n, !1, r),
                u.safeGet(o.listens_, a) === l) &&
                  i(
                    e
                      ? 401 == e
                        ? 'permission_denied'
        ...
        un = (function() {
          function e(e, t, n) {
            ...
            if (
              ...
              (this.eventQueue_ = new Ut()),
              (this.nextWriteId_ = 1),
              (this.interceptServerDataCallback_ = null),
              (this.onDisconnect_ = new rt()),
              (this.persistentConnection_ = null),
              (i = void 0 !== r && r.env[_] ? new kt(n) : new xt(n)),
              (this.stats_ = Lt.getCollection(e)),
              t || U())
            )
              (this.server_ = new an(
                this.repoInfo_,
              ...
              (this.persistentConnection_ = new sn(
                this.repoInfo_,
                this.onDataUpdate_.bind(this),
            ...
            i.addTokenChangeListener(function(e) {
              ...
              (this.infoData_ = new Ot()),
              (this.infoSyncTree_ = new Dt({
                startListening: function(e, t, n, r) {
                  var i = [],
                    s = o.infoData_.getNode(e.path);
                  return (
                    s.isEmpty() ||
                      ((i = o.infoSyncTree_.applyServerOverwrite(e.path, s)),
                      setTimeout(function() {
                        r('ok');
                      }, 0)),
                    i
              ...
              (this.serverSyncTree_ = new Dt({
                startListening: function(e, t, n, r) {
                  return (
                    o.server_.listen(e, n, t, function(t, n) {
                      var i = r(t, n);
          ...
          return (
            ...
            (e.prototype.generateServerValues = function() {
              return (
                ((e = (e = { timestamp: this.serverTime() }) || {}).timestamp =
            ...
            (e.prototype.onDataUpdate_ = function(e, t, n, r) {
              ...
              var i = new V(e);
              t = this.interceptServerDataCallback_
                ? this.interceptServerDataCallback_(e, t)
                : t;
              var o = [];
              if (r)
                if (n) {
            ...
            (e.prototype.setWithPriority = function(e, t, n, r) {
              ...
              var o = this.generateServerValues(),
                ...
                l = this.serverSyncTree_.applyUserOverwrite(e, a, u, !0);
              this.eventQueue_.queueEvents(l),
                this.server_.put(e.toString(), s.val(!0), function(t, n) {
                  var o = 'ok' === t;
                  o || I('set at ' + e + ' failed: ' + t);
                  var s = i.serverSyncTree_.ackUserWrite(u, !o);
                  i.eventQueue_.raiseEventsForChangedPath(e, s),
                    i.callOnCompleteCallback(r, t, n);
                });
              var h = this.abortTransactions_(e);
            ...
            (e.prototype.update = function(e, t, n) {
              ...
              if (
                ...
                this.eventQueue_.queueEvents(u),
                  this.server_.merge(e.toString(), t, function(t, i) {
                    var o = 'ok' === t;
            ...
            (e.prototype.runOnDisconnectEvents_ = function() {
              ...
              var t = this.generateServerValues(),
                n = (function(e, t) {
                  var n = new rt();
                  return (
                    e.forEachTree(new V(''), function(e, r) {
                      n.remember(e, ot(r, t));
                    }),
                    n
                  );
            ...
            (e.prototype.onDisconnectSet = function(e, t, n) {
              var r = this,
                i = ze(t);
              this.server_.onDisconnectPut(e.toString(), i.val(!0), function(
                t,
                o
              ) {
                'ok' === t && r.onDisconnect_.remember(e, i),
                  r.callOnCompleteCallback(n, t, o);
              });
            }),
            (e.prototype.onDisconnectSetWithPriority = function(e, t, n, r) {
              var i = this,
                o = ze(t, n);
              this.server_.onDisconnectPut(e.toString(), o.val(!0), function(
                t,
                n
              ) {
                'ok' === t && i.onDisconnect_.remember(e, o),
                  i.callOnCompleteCallback(r, t, n);
              });
            }),
            ...
            (e.prototype.addEventCallbackForQuery = function(e, t) {
              var n;
              (n =
                '.info' === e.path.getFront()
                  ? this.infoSyncTree_.addEventRegistration(e, t)
                  : this.serverSyncTree_.addEventRegistration(e, t)),
            ...
            (e.prototype.removeEventCallbackForQuery = function(e, t) {
              ...
              (n =
                '.info' === e.path.getFront()
                  ? this.infoSyncTree_.removeEventRegistration(e, t)
                  : this.serverSyncTree_.removeEventRegistration(e, t)),
                this.eventQueue_.raiseEventsAtPath(e.path, n);
            }),
            ...
            (e.prototype.stats = function(e) {
              if ((void 0 === e && (e = !1), 'undefined' != typeof console)) {
                ...
                e
                  ? (this.statsListener_ ||
                      (this.statsListener_ = new Mt(this.stats_)),
                    (t = this.statsListener_.get()))
                  : (t = this.stats_.get());
        ...
        ln = (function() {
          function e(t) {
            (this.indexedFilter_ = new gt(t.getIndex())),
          ...
          return (
            ...
            (e.prototype.updateChild = function(e, t, n, r, i, o) {
              return (
                this.matches(new me(t, n)) || (n = Ve.EMPTY_NODE),
                this.indexedFilter_.updateChild(e, t, n, r, i, o)
              );
            }),
            (e.prototype.updateFullNode = function(e, t, n) {
              t.isLeafNode() && (t = Ve.EMPTY_NODE);
              var r = t.withIndex(this.index_);
              r = r.updatePriority(Ve.EMPTY_NODE);
              var i = this;
              return (
                t.forEachChild(Oe, function(e, t) {
                  i.matches(new me(e, t)) ||
                    (r = r.updateImmediateChild(e, Ve.EMPTY_NODE));
                }),
        ...
        hn = (function() {
          ...
          return (
            (e.prototype.updateChild = function(e, t, n, r, i, o) {
              return (
                this.rangedFilter_.matches(new me(t, n)) || (n = Ve.EMPTY_NODE),
            ...
            (e.prototype.updateFullNode = function(e, t, n) {
              ...
              if (t.isLeafNode() || t.isEmpty())
                r = Ve.EMPTY_NODE.withIndex(this.index_);
              else if (
                ...
                for (var c = !1; i.hasNext(); ) {
                  s = i.getNext();
                  !c && l(a, s) <= 0 && (c = !0),
                    c && o < this.limit_ && l(s, u) <= 0
                      ? o++
                      : (r = r.updateImmediateChild(s.name, Ve.EMPTY_NODE));
                }
              }
            ...
            (e.prototype.fullLimitUpdateChild_ = function(e, t, n, r, i) {
              ...
              if (a.hasChild(t)) {
                for (
                  var p = a.getImmediateChild(t),
                    d = r.getChildAfterChild(this.index_, h, this.reverse_);
                  null != d && (d.name == t || a.hasChild(d.name));

                )
                  d = r.getChildAfterChild(this.index_, d, this.reverse_);
                var f = null == d ? 1 : o(d, l);
                if (c && !n.isEmpty() && f >= 0)
                  return (
                    null != i &&
                      i.trackChildChange(vt.childChangedChange(t, n, p)),
                    a.updateImmediateChild(t, n)
                  );
                null != i && i.trackChildChange(vt.childRemovedChange(t, p));
                var y = a.updateImmediateChild(t, Ve.EMPTY_NODE);
                return null != d && this.rangedFilter_.matches(d)
                  ? (null != i &&
                      i.trackChildChange(vt.childAddedChange(d.name, d.node)),
              ...
              return n.isEmpty()
                ...
                : c && o(h, l) >= 0
                ? (null != i &&
                    (i.trackChildChange(vt.childRemovedChange(h.name, h.node)),
                    i.trackChildChange(vt.childAddedChange(t, n))),
                  a
                    .updateImmediateChild(t, n)
                    .updateImmediateChild(h.name, Ve.EMPTY_NODE))
                : e;
            }),
            e
          );
          ...
          return (
            ...
            (e.prototype.isViewFromLeft = function() {
              return '' === this.viewFrom_
                ? this.startSet_
                : this.viewFrom_ === e.WIRE_PROTOCOL_CONSTANTS_.VIEW_FROM_LEFT;
            }),
            (e.prototype.getIndexStartValue = function() {
              return (
                u.assert(this.startSet_, 'Only valid if start has been set'),
            ...
            (e.prototype.getIndexEndValue = function() {
              return (
                u.assert(this.endSet_, 'Only valid if end has been set'),
                this.indexEndValue_
              );
            }),
            (e.prototype.getIndexEndName = function() {
              return (
                u.assert(this.endSet_, 'Only valid if end has been set'),
                this.endNameSet_ ? this.indexEndName_ : D
              );
            }),
            ...
            (e.prototype.getLimit = function() {
              return (
                u.assert(this.limitSet_, 'Only valid if limit has been set'),
                this.limit_
              );
            }),
            (e.prototype.getIndex = function() {
            ...
            (e.prototype.startAt = function(e, t) {
              ...
              return (
                ...
                null != t
                  ? ((n.startNameSet_ = !0), (n.indexStartName_ = t))
            ...
            (e.prototype.endAt = function(e, t) {
              ...
              return (
                ...
                (n.indexEndValue_ = e),
                void 0 !== t
                  ? ((n.endNameSet_ = !0), (n.indexEndName_ = t))
            ...
            (e.prototype.getQueryObject = function() {
              ...
              if (
                (this.startSet_ &&
                  ...
                  this.startNameSet_ &&
                    (n[t.INDEX_START_NAME] = this.indexStartName_)),
                this.endSet_ &&
                  ((n[t.INDEX_END_VALUE] = this.indexEndValue_),
                  this.endNameSet_ &&
                    (n[t.INDEX_END_NAME] = this.indexEndName_)),
                this.limitSet_)
              ) {
              ...
              return (
                this.index_ !== Oe && (n[t.INDEX] = this.index_.toString()), n
              );
            }),
            ...
            (e.prototype.toRestQueryStringParameters = function() {
              ...
              return this.isDefault()
                ...
                : (this.index_ === Oe
                    ...
                    ? (t = n.KEY_INDEX)
                    : (u.assert(
                        this.index_ instanceof Xe,
                        'Unrecognized index type!'
                      ),
                      (t = this.index_.toString())),
                  (r[n.ORDER_BY] = u.stringify(t)),
                  this.startSet_ &&
                    ((r[n.START_AT] = u.stringify(this.indexStartValue_)),
                    this.startNameSet_ &&
                      (r[n.START_AT] +=
                        ',' + u.stringify(this.indexStartName_))),
                  this.endSet_ &&
                    ((r[n.END_AT] = u.stringify(this.indexEndValue_)),
                    this.endNameSet_ &&
                      (r[n.END_AT] += ',' + u.stringify(this.indexEndName_))),
                  this.limitSet_ &&
                    (this.isViewFromLeft()
        ...
        pn = (function(e) {
          ...
          return (
            ...
            (t.prototype.getKey = function() {
              return (
                u.validateArgCount('Reference.key', 0, 0, arguments.length),
                this.path.isEmpty() ? null : this.path.getBack()
              );
            }),
            (t.prototype.child = function(e) {
              return (
                u.validateArgCount('Reference.child', 1, 1, arguments.length),
                'number' == typeof e
                  ? (e = String(e))
                  : e instanceof V ||
                    (null === this.path.getFront()
                      ? pe('Reference.child', 1, e, !1)
                      : ce('Reference.child', 1, e, !1)),
            ...
            (t.prototype.set = function(e, t) {
              u.validateArgCount('Reference.set', 1, 2, arguments.length),
                de('Reference.set', this.path),
                oe('Reference.set', 1, e, this.path, !1),
                u.validateCallback('Reference.set', 2, t, !0);
              var n = new u.Deferred();
              return (
            ...
            (t.prototype.update = function(e, t) {
              if (
                (u.validateArgCount('Reference.update', 1, 2, arguments.length),
                de('Reference.update', this.path),
                Array.isArray(e))
              ) {
                for (var n = {}, r = 0; r < e.length; ++r) n['' + r] = e[r];
                (e = n),
              ...
              ae('Reference.update', 1, e, this.path, !1),
                u.validateCallback('Reference.update', 2, t, !0);
              var i = new u.Deferred();
              return (
                this.repo.update(this.path, e, i.wrapCallback(t)), i.promise
              );
            }),
            (t.prototype.setWithPriority = function(e, t, n) {
              if (
                ...
                de('Reference.setWithPriority', this.path),
                oe('Reference.setWithPriority', 1, e, this.path, !1),
                ue('Reference.setWithPriority', 2, t, !1),
                u.validateCallback('Reference.setWithPriority', 3, n, !0),
            ...
            (t.prototype.remove = function(e) {
              return (
                u.validateArgCount('Reference.remove', 0, 1, arguments.length),
                de('Reference.remove', this.path),
                u.validateCallback('Reference.remove', 1, e, !0),
                this.set(null, e)
              );
            }),
            (t.prototype.transaction = function(e, t, n) {
              if (
                ...
                de('Reference.transaction', this.path),
                u.validateCallback('Reference.transaction', 1, e, !1),
                u.validateCallback('Reference.transaction', 2, t, !0),
                ye('Reference.transaction', 3, n, !0),
                '.length' === this.getKey() || '.keys' === this.getKey())
              )
              ...
              var i = function(e, n, i) {
                e ? r.reject(e) : r.resolve(new ve(n, i)),
            ...
            (t.prototype.setPriority = function(e, t) {
              u.validateArgCount(
                ...
                de('Reference.setPriority', this.path),
                ue('Reference.setPriority', 1, e, !1),
                u.validateCallback('Reference.setPriority', 2, t, !0);
              var n = new u.Deferred();
              return (
                this.repo.setWithPriority(
            ...
            (t.prototype.push = function(e, t) {
              u.validateArgCount('Reference.push', 0, 2, arguments.length),
                de('Reference.push', this.path),
                oe('Reference.push', 1, e, this.path, !0),
                u.validateCallback('Reference.push', 2, t, !0);
              var n,
            ...
            (t.prototype.onDisconnect = function() {
              return (
                de('Reference.onDisconnect', this.path),
                new _e(this.repo, this.path)
              );
            }),
      ...
      var dn,
        ...
        yn = (function() {
          ...
          return (
            (e.prototype.subTree = function(t) {
              for (
                var n, r = t instanceof V ? t : new V(t), i = this;
                null !== (n = r.getFront());

              ) {
                (i = new e(n, i, u.safeGet(i.node_.children, n) || new fn())),
                  (r = r.popFront());
              }
              return i;
            }),
            ...
            (e.prototype.setValue = function(e) {
              u.assert(void 0 !== e, 'Cannot set value to undefined'),
                (this.node_.value = e),
                this.updateParents_();
            }),
      ...
      !(function(e) {
        ...
        (un.MAX_TRANSACTION_RETRIES_ = 25),
        (un.prototype.transactions_init_ = function() {
          this.transactionQueueTree_ = new yn();
        }),
        (un.prototype.startTransaction = function(e, t, n, r) {
          ...
          if (void 0 === l) {
            if (
              ...
              var h = new $e(s.currentInputSnapshot, new pn(this, s.path), Oe);
              s.onComplete(null, !1, h);
            }
          } else {
            se('transaction failed: Data returned ', l, s.path),
              (s.status = dn.RUN);
            ...
            if (
              'object' == typeof l &&
              null !== l &&
              u.contains(l, '.priority')
            )
              (d = u.safeGet(l, '.priority')),
                u.assert(
                  ie(d),
              ...
              d = (
                this.serverSyncTree_.calcCompleteEventCache(e) || Ve.EMPTY_NODE
              )
                .getPriority()
                .val();
            d = d;
            ...
            this.eventQueue_.raiseEventsForChangedPath(e, g),
              this.sendReadyTransactions_();
          }
        }),
        (un.prototype.getLatestState_ = function(e, t) {
          return (
            this.serverSyncTree_.calcCompleteEventCache(e, t) || Ve.EMPTY_NODE
          );
        }),
        (un.prototype.sendReadyTransactions_ = function(e) {
          ...
          if (
            ...
            u.assert(n.length > 0, 'Sending zero length transaction queue'),
              n.every(function(e) {
        ...
        (un.prototype.sendTransactionQueue_ = function(e, t) {
          for (
            ...
            u.assert(
              ...
              (l.status = dn.SENT),
              l.retryCount++;
            var h = V.relativePath(e, l.path);
            o = o.updateChild(h, l.currentOutputSnapshotRaw);
          }
          var c = o.val(!0),
            p = e;
          this.server_.put(
            ...
            function(r) {
              ...
              if ('ok' === r) {
                for (var o = [], s = 0; s < t.length; s++) {
                  if (
                    ((t[s].status = dn.COMPLETED),
                    (i = i.concat(
                      n.serverSyncTree_.ackUserWrite(t[s].currentWriteId)
                    )),
                    t[s].onComplete)
                  ) {
                    var a = t[s].currentOutputSnapshotResolved,
                      u = new pn(n, t[s].path),
                      l = new $e(a, u, Oe);
                    o.push(t[s].onComplete.bind(null, null, !0, l));
                  }
                  t[s].unwatcher();
                }
                n.pruneCompletedTransactionsBelowNode_(
                  n.transactionQueueTree_.subTree(e)
                ),
                  n.sendReadyTransactions_(),
                  n.eventQueue_.raiseEventsForChangedPath(e, i);
                for (s = 0; s < o.length; s++) Q(o[s]);
              } else {
                if ('datastale' === r)
                  for (s = 0; s < t.length; s++)
                    t[s].status === dn.SENT_NEEDS_ABORT
                      ? (t[s].status = dn.NEEDS_ABORT)
                      : (t[s].status = dn.RUN);
                else {
                  I('transaction at ' + p.toString() + ' failed: ' + r);
                  for (s = 0; s < t.length; s++)
                    (t[s].status = dn.NEEDS_ABORT), (t[s].abortReason = r);
                }
          ...
          if (0 !== e.length) {
            for (
              ...
              if (
                ...
                if (a.retryCount >= un.MAX_TRANSACTION_RETRIES_)
                  (h = !0),
                    (c = 'maxretry'),
                    (i = i.concat(
                      this.serverSyncTree_.ackUserWrite(a.currentWriteId, !0)
                  ...
                  if (void 0 !== d) {
                    ...
                    ('object' == typeof d &&
                      null != d &&
                      u.contains(d, '.priority')) ||
                      (f = f.updatePriority(p.getPriority()));
                    var y = a.currentWriteId,
              ...
              if (
                (this.eventQueue_.raiseEventsForChangedPath(t, i),
                (i = []),
                h &&
                  ((e[s].status = dn.COMPLETED),
                  (n = e[s].unwatcher),
                ...
                if ('nodata' === c) {
                  ...
                  r.push(e[s].onComplete.bind(null, new Error(c), !1, null));
            }
        ...
        (un.prototype.getAncestorTransactionNode_ = function(e) {
          for (
            ...
            null !== (t = e.getFront()) && null === n.getValue();
        ...
        (un.prototype.pruneCompletedTransactionsBelowNode_ = function(e) {
          ...
          if (n) {
            for (var r = 0, i = 0; i < n.length; i++)
              n[i].status !== dn.COMPLETED && ((n[r] = n[i]), r++);
        ...
        (un.prototype.abortTransactionsOnNode_ = function(e) {
          ...
          if (null !== t) {
            for (var n = [], r = [], i = -1, o = 0; o < t.length; o++)
              if (t[o].status === dn.SENT_NEEDS_ABORT);
              else if (t[o].status === dn.SENT)
                u.assert(
                  i === o - 1,
                  'All SENT items should be at beginning of queue.'
                ),
                  (i = o),
                  (t[o].status = dn.SENT_NEEDS_ABORT),
                  (t[o].abortReason = 'set');
              else if (
                (u.assert(
                  t[o].status === dn.RUN,
                ...
                t[o].unwatcher(),
                (r = r.concat(
                  this.serverSyncTree_.ackUserWrite(t[o].currentWriteId, !0)
                )),
                t[o].onComplete)
              ) {
                n.push(t[o].onComplete.bind(null, new Error('set'), !1, null));
              }
            -1 === i ? e.setValue(null) : (t.length = i + 1),
              this.eventQueue_.raiseEventsForChangedPath(e.path(), r);
          ...
          return (
            ...
            (e.prototype.databaseFromApp = function(e, t) {
              ...
              return (
                void 0 !== r && (s = r.env[_]),
                s &&
                  ((n = 'http://' + s + '?ns=' + o.namespace),
                  (o = (i = J(n)).repoInfo)),
                fe('Invalid Firebase Database URL', 1, i),
                i.path.isEmpty() ||
                  N(
            ...
            (e.prototype.deleteRepo = function(e) {
              ...
              (t && u.safeGet(t, e.repoInfo_.toURLString()) === e) ||
                N(
                  'Database ' +
                    e.app.name +
                    '(' +
            ...
            (e.prototype.createRepo = function(e, t) {
              ...
              return (
                ...
                (r = new un(e, this.useRestClient_, t)),
                (n[e.toURLString()] = r),
                r
              );
            }),
          ...
          return (
            ...
            (e.prototype.ref = function(e) {
              return (
                ...
                u.validateArgCount('database.ref', 0, 1, arguments.length),
                e instanceof pn
            ...
            (e.prototype.refFromURL = function(e) {
              ...
              this.checkDeleted_(t),
                u.validateArgCount(t, 1, 1, arguments.length);
              var n = J(e);
              fe(t, 1, n);
              var r = n.repoInfo;
              return (
            ...
            (e.prototype.checkDeleted_ = function(e) {
              null === this.repo_ &&
                N('Cannot call ' + e + ' on a deleted database.');
            }),
            (e.prototype.goOffline = function() {
              u.validateArgCount('database.goOffline', 0, 0, arguments.length),
                this.checkDeleted_('goOffline'),
                this.repo_.interrupt();
            }),
            (e.prototype.goOnline = function() {
              u.validateArgCount('database.goOnline', 0, 0, arguments.length),
              ...
              return a.__awaiter(this, void 0, void 0, function() {
                return a.__generator(this, function(e) {
                  return (
                    ...
                    vn.getInstance().deleteRepo(this.database.repo_),
      ...
      var bn = tn,
        ...
        Sn = Object.freeze({
          DataConnection: En,
          RealTimeConnection: bn,
          hijackHash: function(e) {
            var t = sn.prototype.put;
            return (
              (sn.prototype.put = function(n, r, i, o) {
      ...
      function Nn(t) {
        var n;
        (n = t.SDK_VERSION), ($t = n);
        var r = t.INTERNAL.registerService(
          'database',
          function(e, t, n) {
  ...
  function(e, t) {
    ...
    function p() {
      h &&
        u &&
        ((h = !1), u.length ? (l = u.concat(l)) : (c = -1), l.length && d());
    }
    function d() {
      if (!h) {
        var e = a(p);
    ...
    (i.nextTick = function(e) {
      ...
      l.push(new f(e, t)), 1 !== l.length || h || a(d);
    }),
